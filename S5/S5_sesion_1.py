...
=======
    ...
    #los volvi a comentar ya que el valor ya persiste en base de datos

    # PRUEBA: Intenta registrar 'Atlas' dos veces. ¿Que mensaje recibes? ¿Por que?
    # CONCLUSION:
    # [DB] Agente 'Atlas' registrado con exito.
    # [DB] Agente 'Nova' registrado con exito.
...
=======
    ...
    # CONCLUSION:
    # Ejecute y me dice que none cuando no encuentra pero a su ves intentamos probar si existe o no existe
    # Agente encontrado: {'nombre': 'Atlas', 'rol': 'explorador', 'energia': 100}
...
=======
    ...
    # CONCLUSION:
    #Se envia el mensaje y nos retorna una confirmación con la hora
    # print(enviar_mensaje("Pipe", "Atlas", "Hola Atlas como estas??."))
...
=======
    ...
    # CONCLUSION:
    registrar_agente("Hermes", "mensajero", 120)
    enviar_mensaje("Atlas", "Hermes", "Necesito que lleves este mensaje a Nova.")
    enviar_mensaje("Nova", "Hermes", "Por favor, entrega el drone de analisis a Atlas.")
