...
RUTA_JSON = os.path.join(os.path.dirname(__file__), "..", "usuarios.json") ## Ruta absoluta al archivo JSON, relativa a la ubicación de este archivo (utils/), sube un nivel (..) para llegar a taller_1/
